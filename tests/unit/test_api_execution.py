...
def test_good_text_to_db_similar_execution():
    ...
    assert apitest.run_api_tests(15, mkpath("lamdba_test_request_incident_15.json"), payloadKey="text", route="/text-to-db-similar")
    assert apitest.run_api_tests(10, mkpath("lamdba_test_request_incident_10.json"), payloadKey="text", route="/text-to-db-similar")
...
def test_good_embed_to_db_similar_execution():
    ...
    assert apitest.run_api_tests(15, mkpath("lamdba_test_request_incident_15_embedding.json"), payloadKey="embed", route="/embed-to-db-similar")
    assert apitest.run_api_tests(10, mkpath("lamdba_test_request_incident_10_embedding.json"), payloadKey="embed", route="/embed-to-db-similar")

def test_incorrect_text_to_db_similar_value():
    assert not apitest.run_api_tests(-5, mkpath("lamdba_test_request_incident_15.json"), payloadKey="text", route="/text-to-db-similar")

def test_incorrect_embed_to_db_similar_value():
    assert not apitest.run_api_tests(-5, mkpath("lamdba_test_request_incident_15.json"), payloadKey="embed", route="/embed-to-db-similar")
